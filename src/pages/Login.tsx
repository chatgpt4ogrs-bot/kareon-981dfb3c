...
import { Loader2, LogIn, Mail, Heart, User, Phone } from "lucide-react";
  ...
  return (
    <main className="min-h-screen w-full bg-background relative overflow-hidden flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md space-y-6 animate-fade-in">
        ...
        <div className="border border-border/60 bg-card/80 backdrop-blur-xl shadow-soft-lg p-7 sm:p-9 space-y-6 rounded-2xl">
            ...
            <TabsContent value="login" className="mt-5">
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                {emailNaoVerificado && (
                  <Alert>
                    <AlertDescription>
                      Verifique seu email para acessar o sistema.
                    </AlertDescription>
                  </Alert>
                )}
